...
%%
[X,R] = readgeoraster("data/SHOCK/20170814 Sierra Leone Mudslide/Google25D/ZE/2020.tif");
fp_dir = "data/SHOCK/20170814 Sierra Leone Mudslide/Google25D/ZV/";
...
if createTrainTiles == 1
    ...
    save('data/SHOCK/20170814 Sierra Leone Mudslide/createTiles.mat', ...
         "labelsCells","nodesGlobalCells","featuresCells","adjacencyCells")
else
    load('data/SHOCK/20170814 Sierra Leone Mudslide/createTiles.mat', ...
         "labelsCells","nodesGlobalCells","featuresCells","adjacencyCells")
end
...
if datasplit == 1
    ...
    filename = 'data/SHOCK/20170814 Sierra Leone Mudslide/datasplit.csv';
    writetable(T, filename);
else
    T = readtable('data/SHOCK/20170814 Sierra Leone Mudslide/datasplit.csv');
end
...
while epoch < numEpochs 
    ...
    save('data/SHOCK/20170814 Sierra Leone Mudslide/GraphVSSM_OVparameters.mat', "pOV_decoder","pOV_encoder")
    savefig(fig31,'data/SHOCK/20170814 Sierra Leone Mudslide/OV_ReconLoss.fig'); 
    savefig(fig32,'data/SHOCK/20170814 Sierra Leone Mudslide/OV_KL.fig'); 
end
...
c1 = 4000;
c2 = 17410;
fp_data_norm = fp_data(r1:r2, c1:c2, :)./sum(fp_data(r1:r2, c1:c2, :),3);
fp_data_norm(isnan(fp_data_norm)) = 0;


for yr = 2016:2023
    tmp = readgeoraster("data/SHOCK/20170814 Sierra Leone Mudslide/Google25D/ZE/"+string(yr)+".tif");
    tmp = tmp(r1:r2, c1:c2);
    tmp(tmp<=0)                       = 0;
...
croppedR = R;
croppedR.RasterSize = size(tmp(:,:,1)); 
croppedR.XWorldLimits = R.XWorldLimits(1) + [c1-1, c2-1]*R.CellExtentInWorldX;
croppedR.YWorldLimits = R.YWorldLimits(2) - [r2-1, r1-1]*R.CellExtentInWorldY;


%%
[~,~] = mkdir("data/SHOCK/20170814 Sierra Leone Mudslide/Google25D/FINAL");
fnInfer = 1;
for yr = 2016:2023
    yr
    ...
    for i = 1:length(fp_label)
        disp([yr,fp_label(i)])
        geotiffwrite("data/SHOCK/20170814 Sierra Leone Mudslide/Google25D/FINAL"+'/'+string(yr)+"_"+string(fp_label(i))+'.tif', ...
            OV.p.Infer(:,:,i), croppedR, 'CoordRefSysCode', 32628);
    end
end